# -*- coding: utf-8 -*-
"""Multimodal Use Cases using Llama_3_2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10AwEcbT-1INi9RKHzYLyLsQ30OujKGvO

<a href="https://colab.research.google.com/github/varunfb/llama/blob/main/build_with_Llama_3_2.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
base64_image = encode_image("resized_image.jpg")
...
await run_main("resized_image.jpg",
...
## iOS Instructions
[Link](https://github.com/pytorch/executorch/tree/main/examples/demo-apps/apple_ios/ExecuTorchDemo)
...
<thead>
  <tr>
    <th colspan="3">Useful URLs</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td>LinkedIn</td>
    <td>Current Notebook</td>
    <td>Llama Recipes</td>
  </tr>
  <tr>
    <td>https://www.linkedin.com/in/varunvontimitta/</td>
    <td>https://github.com/varunfb/llama</td>
    <td>https://github.com/meta-llama/llama-recipes/</td>
  </tr>
  <tr>
    <td><img src="./images/varun-linkedin.png" width="300" height="300" alt="LinkedIn"/></td>
    <td><img src="./images/varunfb-github.png" width="300" height="300" alt="Github"/></td>
    <td><img src="./images/llama-recipes.png" width="300" height="300" alt="Github"/></td>
  </tr>
</tbody>
</table>
"""